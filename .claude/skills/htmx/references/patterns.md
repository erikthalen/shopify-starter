...
<table>
  ...
  <tbody>
    <tr>
      <td>Agent Smith</td>
      <td>void1@null.org</td>
      <td>1</td>
    </tr>
    <tr>
      <td>Agent Smith</td>
      <td>void2@null.org</td>
      <td>2</td>
    </tr>
    <!-- ... initial items ... -->
...
<tr hx-trigger="cancel" class="editing" hx-get="/contact/0">
  ...
  <td>
    ...
    <button class="btn danger" hx-put="/contact/0" hx-include="closest tr">
      Save
    </button>
  </td>
</tr>
...
<div id="tabs">
  <a
    ...
    >Details</a
  >
  <a hx-get="/tabs/settings" hx-target="#tab-content" hx-push-url="true"
    >Settings</a
  >
  <a hx-get="/tabs/activity" hx-target="#tab-content" hx-push-url="true"
    >Activity</a
  >
</div>
...
<div hx-get="/status" hx-trigger="every 2s">Status: Unknown</div>
```
...
<form id="sortable-list" hx-post="/reorder" hx-trigger="end">
  ...
  <div class="item" data-id="3">
    <input type="hidden" name="order[]" value="3" />Item 3
  </div>
</form>
