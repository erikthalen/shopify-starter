...
function init() {
  ...
  const firefox115AndSafari17_0Check =
    supportChecksRelList.supports("modulepreload") // Firefox 115+, Safari 17.0+, Chromium 66+
  const safari15_4AndFirefox116Check =
    Intl.PluralRules && "selectRange" in Intl.PluralRules.prototype // Safari 15.4+, Firefox 116+, Chromium 106+
  const firefox115AndSafari15_4Check =
    firefox115AndSafari17_0Check || safari15_4AndFirefox116Check
